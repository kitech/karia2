...
/**
   ...
   of your program. The name \em GetOpt4 is based on similar utilities
...
{
    if ( !qApp )
        qFatal( "GetOpt4: requires a QApplication instance to be constructed first" );
...
/**
   ...
   \code
   int main(int argc, char **argv) {
   GetOpt4 opt(argc, argv);
   ...
   }
   \endcode
*/
GetOpt4::GetOpt4( int argc, char *argv[] )
{
    init( argc, argv );
}
...
/**
   ...
   the \c main() function.
*/
GetOpt4::GetOpt4( const QStringList &a )
    : args( a )
{
    init( 0, 0 );
}
...
/**
   \internal
*/
void GetOpt4::init( int argc, char *argv[], int offset )
{
...
/**
   \internal
*/
bool GetOpt4::parse( bool untilFirstSwitchOnly )
{
...
/**
   \internal
*/
void GetOpt4::addOption( Option o )
{
    // ### check for conflicts
    options.append( o );
}
...
*/
void GetOpt4::addSwitch( const QString &lname, bool *b )
{
...
/**
   \internal
*/
void GetOpt4::setSwitch( const Option &o )
{
...
*/
void GetOpt4::addOption( char s, const QString &l, QString *v )
{
...
/**
   ...
   \endcode
*/
void GetOpt4::addVarLengthOption( const QString &l, QStringList *v )
{
...
/**
   ...
   \endcode
*/
void GetOpt4::addRepeatableOption( char s, QStringList *v )
{
...
*/
void GetOpt4::addRepeatableOption( const QString &l, QStringList *v )
{
...
/**
   ...
   \sa addOption
*/
void GetOpt4::addOptionalOption( const QString &l, QString *v,
                                const QString &def )
{
...
/**
   ...
   the value is not specified by the user it will be set to \a def.
*/
void GetOpt4::addOptionalOption( char s, const QString &l,
...
/**
   ...
   isSet() function.
*/
void GetOpt4::addArgument( const QString &name, QString *v )
{
...
*/
void GetOpt4::addOptionalArgument( const QString &name, QString *v )
{
    Option opt( OUnknown, 0, name );
    opt.stringValue = v;
    optArg = opt;
...
bool GetOpt4::isSet( const QString &name ) const
{
    return setOptions.find( name ) != setOptions.end();
}

/**
   \fn int GetOpt4::currentArgument() const
   \internal
*/
