...
#ifndef _ARIA2CWSJSONMANAGER_H_
#define _ARIA2CWSJSONMANAGER_H_
...
class Aria2CWSJsonManager : public Aria2RpcManager
{
    Q_OBJECT;
public:
    Aria2CWSJsonManager(bool useSsl, QObject *parent = 0);
    virtual ~Aria2CWSJsonManager();
