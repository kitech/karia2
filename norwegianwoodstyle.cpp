...
void NorwegianWoodStyle::polish(QPalette &palette)
{
	...
	QPixmap backgroundImage(QApplication::applicationDirPath()+"/"+"images/woodbackground.png");
    QPixmap buttonImage(QApplication::applicationDirPath()+"/"+"images/woodbutton.png");
