...
// Version: $Id: taskqueue.h 200 2013-10-04 07:13:26Z drswinghead $
// 
...
public:
    ...
    bool addSubTaskModel(int taskId, QMap<int, QVariant> stats, QModelIndex &pindex, QModelIndex &newIndex);
