...
bool Aria2RpcManager::initBackendState()
{
    QString dhtFilePath;
#ifdef Q_OS_WIN
...
int Aria2RpcManager::findFirstUsableRpcPort()
{
    QTcpServer serv;
...
bool Aria2RpcManager::startBackend()
{
...
bool Aria2RpcManager::stopBackend()
{
    if (this->mAriaProc->state() != QProcess::NotRunning) {
...
bool Aria2RpcManager::restartBackend()
{
    this->stopBackend();
    this->startBackend();
    return true;
...
int Aria2RpcManager::rpcPort()
{
    return this->currentRpcPort;
}

bool Aria2RpcManager::hasFeature(AriaFeature feature)
{
    return feature & this->mFeatures;
    return true;
}

void Aria2RpcManager::onAriaProcError(QProcess::ProcessError err)
{
    qDebug()<<__FUNCTION__<<err;
    emit error(err);
}

void Aria2RpcManager::onAriaProcFinished(int exitCode, QProcess::ExitStatus exitStatus)
{
    qDebug()<<__FUNCTION__<<exitCode<<exitStatus;
    emit finished(exitCode, exitStatus);
}

void Aria2RpcManager::onAriaProcReadyReadStdout()
{
    QString logLine;
...
void Aria2RpcManager::onAriaProcReadyReadStdoutWithParser()
{
    QString logLine;
    while(this->mAriaProc->bytesAvailable() > 0) {
        if (this->mAriaProc->canReadLine()) {
...
void Aria2RpcManager::onAriaProcReadyReadStderr()
{
    QString logLine;
    while(this->mAriaProc->bytesAvailable() > 0) {
        if (this->mAriaProc->canReadLine()) {
...
void Aria2RpcManager::onAriaProcStarted()
{
...
void Aria2RpcManager::onAriaProcStateChanged(QProcess::ProcessState newState)
{
    Q_UNUSED(newState);
}

void Aria2RpcManager::onLogChannelReadyRead()
{
    QString line;
...
void Aria2RpcManager::onAriaGetFeatureResponse(QVariant &response, QVariant &payload)
{
...
void Aria2RpcManager::onAriaGetFeatureFault(int code, QString reason, QVariant &payload)
{
